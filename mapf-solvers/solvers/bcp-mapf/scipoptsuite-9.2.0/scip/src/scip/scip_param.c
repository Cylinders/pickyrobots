   ...
   )
{
   ...
   SCIPsetSetIntParam(scip->set, scip->messagehdlr, name, value);
   ...
   )
{
   ...
   SCIPsetSetLongintParam(scip->set, scip->messagehdlr, name, value);
   ...
   )
{
   ...
   SCIPsetSetRealParam(scip->set, scip->messagehdlr, name, value);
