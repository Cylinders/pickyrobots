   ...
   )
{
   ...
   SCIPcheckStage(scip, "SCIPprintStatistics", TRUE, TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE);
   ...
   for( i = 0; i < ntables; ++i )
   {
      ...
      SCIPtableOutput(tables[i], scip->set, file);
   }
