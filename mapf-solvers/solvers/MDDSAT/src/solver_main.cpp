...
/*                                                                            */
/*============================================================================*/
// solver_main.cpp / 0.12-beersheva_077
/*----------------------------------------------------------------------------*/
//
...
/*----------------------------------------------------------------------------*/
    ...
    {
	printf("================================================================\n");
	printf("%s : Multirobot Solution solver\n", sPRODUCT);
	printf("%s\n", sCOPYRIGHT);
	printf("----------------------------------------------------------------\n");
    }
	...
	printf("                          bitwise|flow|matching|Hmatching|direct|Hdirect|simplicial|Hsimplicial|mmdd|\n");
	printf("                          singular|plural|plural2|heighted|mddnomdd|idmdd|decomposed|independent}]\n");
