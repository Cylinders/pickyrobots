...
/*                                                                            */
/*============================================================================*/
// compress.cpp / 0.12-beersheva_077
/*----------------------------------------------------------------------------*/
//
...
// sMultirobotSolutionCompressor
    ...
    const sString sMultirobotSolutionCompressor::CNF_INVERSE_FILENAME_PREFIX = "compress/makespan_compression_input.inv";
    const sString sMultirobotSolutionCompressor::CNF_ADVANCED_FILENAME_PREFIX = "compress/makespan_compression_input.adv";
    const sString sMultirobotSolutionCompressor::CNF_DIFFERENTIAL_FILENAME_PREFIX = "compress/makespan_compression_input.dif";
    const sString sMultirobotSolutionCompressor::CNF_BIJECTION_FILENAME_PREFIX = "compress/makespan_compression_input.bij";
    const sString sMultirobotSolutionCompressor::CNF_HEURISTIC_ADVANCED_FILENAME_PREFIX = "compress/makespan_compression_input.hadv";
    const sString sMultirobotSolutionCompressor::CNF_HEURISTIC_DIFFERENTIAL_FILENAME_PREFIX = "compress/makespan_compression_input.hdif";
    const sString sMultirobotSolutionCompressor::CNF_HEURISTIC_BIJECTION_FILENAME_PREFIX = "compress/makespan_compression_input.hbij";
    const sString sMultirobotSolutionCompressor::CNF_BITWISE_FILENAME_PREFIX = "compress/makespan_compression_input.bit";
    const sString sMultirobotSolutionCompressor::CNF_FLOW_FILENAME_PREFIX = "compress/makespan_compression_input.flw";
    const sString sMultirobotSolutionCompressor::CNF_MATCHING_FILENAME_PREFIX = "compress/makespan_compression_input.mch";
    const sString sMultirobotSolutionCompressor::CNF_HEURISTIC_MATCHING_FILENAME_PREFIX = "compress/makespan_compression_input.hmch";
    const sString sMultirobotSolutionCompressor::CNF_DIRECT_FILENAME_PREFIX = "compress/makespan_compression_input.dir";
    const sString sMultirobotSolutionCompressor::CNF_HEURISTIC_DIRECT_FILENAME_PREFIX = "compress/makespan_compression_input.hdir";
    const sString sMultirobotSolutionCompressor::CNF_SIMPLICIAL_FILENAME_PREFIX = "compress/makespan_compression_input.sim";
    const sString sMultirobotSolutionCompressor::CNF_HEURISTIC_SIMPLICIAL_FILENAME_PREFIX = "compress/makespan_compression_input.hsim";
    const sString sMultirobotSolutionCompressor::CNF_SINGULAR_FILENAME_PREFIX = "compress/makespan_compression_input.sin";
    const sString sMultirobotSolutionCompressor::CNF_PLURAL_FILENAME_PREFIX = "compress/makespan_compression_input.plu";
    const sString sMultirobotSolutionCompressor::CNF_PLURAL2_FILENAME_PREFIX = "compress/makespan_compression_input.pl2";
    const sString sMultirobotSolutionCompressor::CNF_HEIGHTED_FILENAME_PREFIX = "compress/makespan_compression_input.hei";
    const sString sMultirobotSolutionCompressor::CNF_MDD_FILENAME_PREFIX = "compress/makespan_compression_input.mdd";
    const sString sMultirobotSolutionCompressor::CNF_MMDD_FILENAME_PREFIX = "compress/makespan_compression_input.mmdd";
    const sString sMultirobotSolutionCompressor::CNF_IDMDD_FILENAME_PREFIX = "compress/makespan_compression_input.imdd";
    const sString sMultirobotSolutionCompressor::CNF_RXMDD_FILENAME_PREFIX = "compress/makespan_compression_input.rxm";
    const sString sMultirobotSolutionCompressor::CNF_NOMDD_FILENAME_PREFIX = "compress/makespan_compression_input.nmd";
    const sString sMultirobotSolutionCompressor::CNF_RXNOMDD_FILENAME_PREFIX = "compress/makespan_compression_input.rxn";

    const sString sMultirobotSolutionCompressor::OUTPUT_INVERSE_FILENAME_PREFIX = "compress/makespan_compression_output.inv";
    const sString sMultirobotSolutionCompressor::OUTPUT_ADVANCED_FILENAME_PREFIX = "compress/makespan_compression_output.adv";
    const sString sMultirobotSolutionCompressor::OUTPUT_DIFFERENTIAL_FILENAME_PREFIX = "compress/makespan_compression_output.dif";
    const sString sMultirobotSolutionCompressor::OUTPUT_BIJECTION_FILENAME_PREFIX = "compress/makespan_compression_output.bij";
    const sString sMultirobotSolutionCompressor::OUTPUT_HEURISTIC_ADVANCED_FILENAME_PREFIX = "compress/makespan_compression_output.hadv";
    const sString sMultirobotSolutionCompressor::OUTPUT_HEURISTIC_DIFFERENTIAL_FILENAME_PREFIX = "compress/makespan_compression_output.hdif";
    const sString sMultirobotSolutionCompressor::OUTPUT_HEURISTIC_BIJECTION_FILENAME_PREFIX = "compress/makespan_compression_output.hbij";
    const sString sMultirobotSolutionCompressor::OUTPUT_BITWISE_FILENAME_PREFIX = "compress/makespan_compression_output.bit";
    const sString sMultirobotSolutionCompressor::OUTPUT_FLOW_FILENAME_PREFIX = "compress/makespan_compression_output.flw";
    const sString sMultirobotSolutionCompressor::OUTPUT_MATCHING_FILENAME_PREFIX = "compress/makespan_compression_output.mch";
    const sString sMultirobotSolutionCompressor::OUTPUT_HEURISTIC_MATCHING_FILENAME_PREFIX = "compress/makespan_compression_output.hmch";
    const sString sMultirobotSolutionCompressor::OUTPUT_DIRECT_FILENAME_PREFIX = "compress/makespan_compression_output.dir";
    const sString sMultirobotSolutionCompressor::OUTPUT_HEURISTIC_DIRECT_FILENAME_PREFIX = "compress/makespan_compression_output.hdir";
    const sString sMultirobotSolutionCompressor::OUTPUT_SIMPLICIAL_FILENAME_PREFIX = "compress/makespan_compression_output.sim";
    const sString sMultirobotSolutionCompressor::OUTPUT_HEURISTIC_SIMPLICIAL_FILENAME_PREFIX = "compress/makespan_compression_output.hsim";
    const sString sMultirobotSolutionCompressor::OUTPUT_SINGULAR_FILENAME_PREFIX = "compress/makespan_compression_output.sin";
    const sString sMultirobotSolutionCompressor::OUTPUT_PLURAL_FILENAME_PREFIX = "compress/makespan_compression_output.plu";
    const sString sMultirobotSolutionCompressor::OUTPUT_PLURAL2_FILENAME_PREFIX = "compress/makespan_compression_output.pl2";
    const sString sMultirobotSolutionCompressor::OUTPUT_HEIGHTED_FILENAME_PREFIX = "compress/makespan_compression_output.hei";
    const sString sMultirobotSolutionCompressor::OUTPUT_MDD_FILENAME_PREFIX = "compress/makespan_compression_output.mdd";
    const sString sMultirobotSolutionCompressor::OUTPUT_MMDD_FILENAME_PREFIX = "compress/makespan_compression_output.mmdd";
    const sString sMultirobotSolutionCompressor::OUTPUT_IDMDD_FILENAME_PREFIX = "compress/makespan_compression_output.imdd";
    const sString sMultirobotSolutionCompressor::OUTPUT_RXMDD_FILENAME_PREFIX = "compress/makespan_compression_output.rxm";
    const sString sMultirobotSolutionCompressor::OUTPUT_NOMDD_FILENAME_PREFIX = "compress/makespan_compression_output.nmd";
    const sString sMultirobotSolutionCompressor::OUTPUT_RXNOMDD_FILENAME_PREFIX = "compress/makespan_compression_output.rxn";
...
/*----------------------------------------------------------------------------*/
    ...
    sMultirobotSolutionCompressor::sMultirobotSolutionCompressor(const sMultirobotSolutionCompressor &solution_compressor)
	: m_minisat_timeout(solution_compressor.m_minisat_timeout)
	, m_total_timeout(solution_compressor.m_total_timeout)
	, m_makespan_upper_bound(solution_compressor.m_makespan_upper_bound)
	, m_minisat_path(solution_compressor.m_minisat_path)
	, m_N_parallel_Threads(solution_compressor.m_N_parallel_Threads)
	, m_encoding(solution_compressor.m_encoding)
    {
	// nothing
    }


    const sMultirobotSolutionCompressor& sMultirobotSolutionCompressor::operator=(const sMultirobotSolutionCompressor &solution_compressor)
    {
	m_minisat_timeout = solution_compressor.m_minisat_timeout;
	m_total_timeout = solution_compressor.m_total_timeout;
	m_makespan_upper_bound = solution_compressor.m_makespan_upper_bound;
...
/*----------------------------------------------------------------------------*/
	...
	sMultirobotEncodingContext_CNFsat final_encoding_context;
	sMultirobotInstance instance(environment, start_arrangement, final_arrangement);

	result = compute_OptimalMakespan(start_arrangement, final_arrangement, environment, sparse_environment, makespan_upper_bound, optimal_makespan, final_encoding_context, thread_id);
	if (sFAILED(result))
	{
	    return result;
	}
	if (optimal_makespan != MAKESPAN_UNDEFINED)
	{
		...
		instance.construct_MakespanMDD(optimal_makespan, MDD);

		result = extract_ComputedMmddSolution(start_arrangement, environment, MDD, optimal_makespan, final_encoding_context, optimal_solution, thread_id);
		if (sFAILED(result))
		{
		    return result;
		}
	...
	result = compute_OptimalMakespan_(start_arrangement, final_arrangement, environment, sparse_environment, makespan_upper_bound, optimal_makespan, final_encoding_context, thread_id);
	if (sFAILED(result))
	{
	    return result;
	}
	...
	result = compute_OptimalMakespan(start_arrangement, final_arrangement, environment, sparse_environment, makespan_lower_bound, makespan_upper_bound, optimal_makespan, final_encoding_context, thread_id);
	if (sFAILED(result))
	{
	    return result;
	}
...
#ifdef sSTATISTICS
	    {
//		s_GlobalPhaseStatistics.enter_Phase("Phase" + sInt_32_to_String(total_cost));
	    }
#endif
	    switch (m_encoding)
	    {
...
//	s_GlobalPhaseStatistics.leave_Phase();
	...
	else if (strcmp(answer, "SAT") == 0)
	{
	    ...
	    case ENCODING_BCMDD:
	    {
		instance.construct_MDD(encoding_context.m_max_total_cost, MDD, extra_cost, extra_MDD);
	    ...
	    case ENCODING_BCNOMDD:
	    {
		instance.construct_NoMDD(encoding_context.m_max_total_cost, MDD, extra_cost, extra_MDD);
...
//	    printf("NLUB:%d,%d,%d,%d\n", next_upper_total_bound, lower_total_bound, upper_total_bound, best_extra_cost);
	...
	while (true)
	{
		...
		case ENCODING_BCNOMDD:
		{
		    instance.construct_NoMDD(final_encoding_context.m_max_total_cost, MDD, extra_cost, extra_MDD);
...
//	    total_cost += 30;
	...
	result = compute_OptimalCost(start_arrangement, final_arrangement, environment, sparse_environment, max_total_cost, optimal_cost, final_encoding_context, thread_id);
	if (sFAILED(result))
	{
	    return result;
	}
	...
	{	
		...
		int mdd_depth = instance.construct_MDD(final_encoding_context.m_max_total_cost, MDD, extra_cost, extra_MDD);
		...
		int mdd_depth = instance.construct_NoMDD(final_encoding_context.m_max_total_cost, MDD, extra_cost, extra_MDD);
	...
	for (int g = 0; g < robot_Groups.size(); ++g)
	{
		...
		{
		    multirobot_solution.add_Move(time_step, sMultirobotSolution::Move(robot_Groups[g][move->m_robot_id - 1],
										      move->m_src_vrtx_id,
										      move->m_dest_vrtx_id));
		}
		++time_step;
...
#ifdef sVERBOSE
		printf("Computing solution for group %d (size:%d) ...\n", g, robot_Groups[g].size());
#endif
...
//	int N_Robots = start_arrangement.get_RobotCount();
	...
	dist_environment.calc_AllPairsShortestPaths();

//	const sUndirectedGraph::Distances_2d_vector &all_pairs_Distances = dist_environment.get_AllPairsShortestPaths();
...
*/
	...
	for (int robot_id = 1; robot_id <= N_Robots; ++robot_id)
	{
	    ...
	    printf("%d\n", all_pairs_Distances[start_arrangement.get_RobotLocation(robot_id)][*robot_Vertices.begin()]);
//	    Robots.insert(Robots_map::value_type(*robot_Vertices.begin(), robot_id));
	    Robots.insert(Robots_map::value_type(all_pairs_Distances[start_arrangement.get_RobotLocation(robot_id)][*robot_Vertices.begin()], robot_id));
	}
...
/*----------------------------------------------------------------------------*/
	...
	robot_Locations.resize(start_arrangement.get_RobotCount() + 1, sRobotArrangement::UNDEFINED_LOCATION);
	...
	{
	    robot_Locations[layer].resize(start_arrangement.get_RobotCount() + 1, sRobotArrangement::UNDEFINED_LOCATION);
	}
